...
#features = ['Efficiency','Specificity','BS_Length','Distance_exon_BS (D)']#,'K_Median_Fold_change'] #'K_Avg_Fold_change', 'K_Median_Fold_change'
#features = ['Efficiency']
#features = ['Specificity']
#features = ['BS_Length']
features = ['Distance_exon_BS (D)']

target = 'K_Avg_Fold_change'   #try target = 'K_Median_Fold_change’ in another run
